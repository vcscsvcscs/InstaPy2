...
class Settings:
    ...
    database_location = localize_path("db", "instapy2.db")

    # set a logger cache outside the InstaPy2 object to avoid
    ...
    # state of instantiation of InstaPy2
    InstaPy_is_running = False

    # This is where currently the pods server is hosted
    pods_server_endpoint = "https://us-central1-instapy2-pods.cloudfunctions.net"
    pods_fashion_server_endpoint = (
        "https://us-central1-instapy2-pods-fashion.cloudfunctions.net"
    )
    pods_food_server_endpoint = (
        "https://us-central1-instapy2-pods-food.cloudfunctions.net"
    )
    pods_travel_server_endpoint = (
        "https://us-central1-instapy2-pods-travel.cloudfunctions.net"
    )
    pods_sports_server_endpoint = (
        "https://us-central1-instapy2-pods-sports.cloudfunctions.net"
    )
    pods_entertainment_server_endpoint = (
        "https://us-central1-instapy2-pods-entertainment.cloudfunctions.net"
    )
