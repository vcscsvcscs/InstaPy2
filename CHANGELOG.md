...
- Fixed saving account progress by changing all references of sharedData to graphql.user.

### Changed

- Change the ip data supplier to <http://ip-api.com/> from <https://freegeoip.app/>
